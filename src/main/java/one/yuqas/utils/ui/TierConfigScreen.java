...
public class TierConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, this.title, centerX, 10, 0xFFCC00);

        int descY = 35;
        context.drawCenteredTextWithShadow(this.textRenderer,
                Text.literal(Config.TAG.getDescription()), centerX, descY, 0x999999);
        context.drawCenteredTextWithShadow(this.textRenderer,
                Text.literal(Config.SIDE.getDescription()), centerX, descY + 35, 0x999999);
        context.drawCenteredTextWithShadow(this.textRenderer,
                Text.literal(Config.TIER_TYPE.getDescription()), centerX, descY + 70, 0x999999);
        context.drawCenteredTextWithShadow(this.textRenderer,
                Text.literal(Config.TAB_TAG.getDescription()), centerX, descY + 105, 0x999999);
        context.drawCenteredTextWithShadow(this.textRenderer,
                Text.literal(Config.TAB_SIDE.getDescription()), centerX, descY + 140, 0x999999);
    }
